...
export type PostWithArtworksQuestionAndAnswers = Prisma.PostGetPayload<{
    include: {
        user: true;
        artworks: true;
        question: { include: { answers: { include: { users: true } }; user: true } };
    };
}>;
        ...
        <Card
            ...
            <div className="p-5 pb-4">
                <div className="flex items-center justify-between">
                    ...
                    <button
                        className="w-10 h-10 flex items-center justify-center rounded-2xl hover:bg-gray-100 transition-colors duration-300 group">
