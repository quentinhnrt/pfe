      ...
      return {
        ...
        data: {
          ...
          [action.tabKey!]: action.reset
            ? (action.data as Artwork[] | Post[])
            : [
                ...(state.data[action.tabKey!] || []),
                ...(action.data as Artwork[] | Post[]),
              ],
        },
      };
          ...
          <div className="flex items-center justify-between text-xs text-muted-foreground">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button
                ...
                aria-label="Voir les détails de cette publication"
                onClick={(e) => e.stopPropagation()}
              >
      ...
      >
        ...
        <ScrollArea className="flex-1 overflow-hidden">
          <div
            ...
            className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 p-4 sm:p-6"
          >
            <div className="space-y-4 order-1">
              <div className="aspect-square overflow-hidden rounded-lg bg-gray-100 max-h-[60vh] xl:max-h-none">
                <img
                  src={artwork.thumbnail}
            ...
            <div className="space-y-4 sm:space-y-6 order-2">
              ...
              <div className="pt-3 sm:pt-4 border-t text-xs text-muted-foreground space-y-1">
                <p>ID de l&apos;œuvre: {artwork.id}</p>
                <p>
                  Dernière mise à jour:{" "}
                  {new Date(artwork.updatedAt).toLocaleString("fr-FR")}
                </p>
              </div>
            </div>
          </div>
