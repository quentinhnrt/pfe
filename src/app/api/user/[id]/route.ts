...
export async function PUT(
    ...
    const image = data.get("image") ? await uploadImage(data.get("image") as File) : null;
    const bannerImage = data.get("bannerImage") ? await uploadImage(data.get("bannerImage") as File) : null;
