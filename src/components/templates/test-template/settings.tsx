...
import {TemplateContainer} from "@/shared/components/template-container/TemplateContainer";
                                        ...
                                        (item, index, handleChange) => (
                                            <>
                                                ...
                                                <Input
                                                    ...
                                                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                                />
                                                <ArtworkGallerySelector name={`artworkSections.${index}.artworks`}
                                                                        onChange={(selectedIds) => handleChange(index, "artworks", selectedIds)}/>
                                            </>
                                        )
                                    }/>
                            </FormControl>
