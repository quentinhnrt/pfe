        ...
        <div className="flex flex-col items-center w-full max-w-4xl mx-auto">
            ...
            {!suggestionsDisabled && artists.length > 0 && (
                <div className="mt-6 w-full">
                        ...
                        {artists.map((artist, index) => (
                            ...
                            >
                                <div className="relative">
                                    {artist.image ? (
                                        <div
                                            className="w-10 h-10 rounded-full overflow-hidden transition-colors duration-300">
                                            <Image
                                                src={artist.image}
                                        ...
                                        <div
                                            className="w-10 h-10 flex items-center justify-center bg-gray-100 text-gray-700 text-sm font-bold rounded-full border-2 border-gray-200 group-hover:border-gray-300 transition-colors duration-300">
                  ...
                  <span
                      className="text-gray-900 dark:text-white font-medium text-sm group-hover:text-black transition-colors duration-300 truncate">
                    {`${artist.firstname ?? ""} ${artist.lastname ?? ""}`.trim() || "Artiste"}
                  </span>
                                    <span
                                        className="text-gray-500 text-xs group-hover:text-gray-600 transition-colors duration-300">
                    Artiste
                  </span>
                                </div>
                                <ChevronRight
